...
public class HealthRecommendation {
    ...
    private HealthMetric userSystolic;
    private HealthMetric userDystolic;
    private HealthMetric userHeartRate;
    private HealthMetric userGlucose;
      
    public HealthRecommendation(HealthMetric systolic, HealthMetric dystolic, HealthMetric userHeartRate, HealthMetric userGlucose) {
        this.userSystolic = systolic;
        this.userDystolic = dystolic;
     ...
     * Returns 0 if systolic or dystolic blood pressure is unrealistic. 
     * 1 = unhealthy (should seek immediate medical attention)
     * 5 = healthy   
     */
    public int compareBloodPressure() {
        float s = userSystolic.getSystolic();
        float d = userDystolic.getDystolic();
     ...
     * Returns 0 if input is unrealistic for resting heart rate.  
     * 1 = unhealthy (should seek immediate medical attention)
     * 5 = healthy
     */
    
    public int compareHeartRate() {
        float hr = userHeartRate.getHeartRate();
     ...
     * Returns 0 if input is unrealistc for blood glucose. 
     * 1 = unhealthy (should seek immediate medical attention)
     * 5 = healthy 
     */
    public int compareGlucose() {
        float g = userGlucose.getGlucose();
