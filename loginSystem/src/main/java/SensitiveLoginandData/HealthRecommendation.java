...
public class HealthRecommendation {
    ...
    public int compareBloodPressure(float s, float d) {
    	int rating = 0;
    	HealthMetric sbp = new HealthMetric(s,"systolicbp");
    	HealthMetric dbp = new HealthMetric(d,"dystolicbp");
    	if (sbp.validateSystolic(s) && dbp.validateDystolic(d)) {
    		rating = 5;
    ...
    public int compareHeartRate(float hr) {
    	int rating = 0;
    	HealthMetric heartbeat = new HealthMetric(hr,"heartrate");
    	if (heartbeat.validateHeartInput(hr)) {
    		rating = 5;
    ...
    public int compareGlucose(float g) {
    	int rating = 0;
    	HealthMetric glucose = new HealthMetric(g,"glucose");
    	if (glucose.validateGlucose(g)) {
    		 rating = 5;
